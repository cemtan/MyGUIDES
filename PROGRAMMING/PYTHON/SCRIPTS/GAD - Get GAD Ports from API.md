...
def get_replication(f_svp):
	...
	url = "https://{}/ConfigurationManager/v1/services/storage-cache-service/actions/refresh/invoke".format(f_svp['ip'])
	api_post(url, headers, 'Refrashing the cache of Configuration Manager')
...
if not df1.empty and not dg1.empty and not df2.empty and not dg2.empty:
	...
	dg11 = dg1'ldevId', 'numOfPorts'
	dg21 = dg2'ldevId', 'numOfPorts'
	dg11.columns = ['pvolLdevId', 'pvolNumOfPorts']
	dg21.columns = ['svolLdevId', 'svolNumOfPorts']
	...
	dg11.columns = ['svolLdevId', 'svolNumOfPorts']
	dg21.columns = ['pvolLdevId', 'pvolNumOfPorts']
